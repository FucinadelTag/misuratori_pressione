Snipcart.execute('registerLocale', 'it', {
yes:
"Si",
no:
"No",
...
"Pagerai direttamente al corriere al momento della consegna.",
pay_via_mollie:
...
"Totale",
cart_empty_text:
"IL TUO CARRELLO È VUOTO. INSERISCI ALMENO UN PRODOTTO",
...
"Per favore inserisci il tuo indirizzo email. Ti invieremo le istruzioni per creare una nuova password.",
forgot_password_success_email_sent:
"Email inviata",
forgot_password_email_sent_message:
"Un'emal ti è stata inviata con le istruzioni per creare una nuova password. Controlla la tua casella di posta e segui le istruzioni.",
login_checkout_as_guest:
"Acquista come ospite",
login_checkout_as_guest_notice:
"Acquista come ospite se non vuoi registrati. Sappi che le tue informazioni non saranno salvarte per eventuali oridni successivi.",
...
"CLicca qui per modificare il tuo indirizzo di spedizione",
...
"Crea un account",
why_create_account:
"Per semplificare il tuo prossimo ordine, inserisci una password per creare un account.",
reset_password:
"Crea una nuova password",
reset_password_success:
"Password ricreata con successo",
reset_password_changed:
"La tua password è stata modificata.",
reset_password_click_here_to_login:
"CLicca qui per accedere",
thankyou_message:
"Grazie per il tuo ordine! La tua fattura ti verrà inviata via email, la riceverai presto.",
thankyou_submessage:
...
"Un utente con questo indirizzo email esiste già",
errors_both_password_must_match:
"Entrambe le password devono essere uguali",
errors_email_must_be_valid:
"L'indirizzo email deve essere valido",
errors_email_does_not_match_any_existing_user:
"Nessun utente esistente con questo indirizzo email",
...
"Informazioni di autenticazioni non valide",
...
"Qualcosa è andato storto durante la convalida dell'ordine, non preoccupatevi, non è stato addebitato.",
error_crawling_unreachable:
"L'oggetto <strong>{0}</strong> è irraggiungibile a <strong>{1}</strong>. Assicurati che l'indirizzo del prodotto sia disponibile pubblicamente.",
error_crawling_product_not_found:
"L'oggetto <strong>{0}</strong> non è stato trovato su <strong>{1}</strong>.",
...
"Ricezione delle tariffe di spedizione...",
saving:
"Salvataggio...",
loading:
"Caricamento...",
...
"Clicca su questo pulsante se preferisci pagare con PayPal.",
